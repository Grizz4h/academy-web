...
DRILL_REGISTRY = {
    ...
    "pattern_log": observation_log_drill.render,
    "multi_observation_pattern": observation_log_drill.render,
    "pattern_condition": observation_log_drill.render,
    "pattern_condition_matrix": observation_log_drill.render,
    "pattern_invariant": observation_log_drill.render,
    "pattern_invariant_map": observation_log_drill.render,
    "pattern_attribution": observation_log_drill.render,
    "pattern_attribution_board": observation_log_drill.render,
    "tendency_profile": observation_log_drill.render,
    "pattern_tendency_profile": observation_log_drill.render,
