...
assert.equal(result.groupA.ratePercent, 63)
...
assert.equal(result.groupB.ratePercent, 29)
assert.equal(result.percentagePointDifference, 34)
assert.equal(calculatePercentagePointDifference(5 / 8, 2 / 7), 34)
