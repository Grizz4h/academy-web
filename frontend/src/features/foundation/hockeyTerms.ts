...
export const HOCKEY_TERMS: HockeyTermDefinition[] = [
  ...
  { id: 'low_middle_high', term: 'Hinter dem Spiel / Auf Verbindungshöhe / Vor dem Spiel', shortDefinition: 'Höhe eines Spielers relativ zum aktuellen Spiel — rückwärtig, verbindend oder vorwärtsgerichtet.', category: 'tactics' },
  { id: 'low', term: 'Hinter dem Spiel', shortDefinition: 'Relativ zur aktuellen Aktion eher auf der rückwärtigen Seite.', category: 'tactics', glossarySlug: 'low' },
  { id: 'middle', term: 'Auf Verbindungshöhe', shortDefinition: 'Zwischen Absicherung und vorderer Fortsetzung — kann Spieler oder Räume verbinden.', category: 'tactics', glossarySlug: 'middle' },
  { id: 'high', term: 'Vor dem Spiel', shortDefinition: 'Relativ zur aktuellen Aktion eher auf der vorwärtsgerichteten Seite.', category: 'tactics', glossarySlug: 'high' },
