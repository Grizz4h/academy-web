...
export const HOCKEY_TERMS: HockeyTermDefinition[] = [
  ...
  { id: 'low_middle_high', term: 'Low / Middle / High', shortDefinition: 'Höhe eines Spielers relativ zum aktuellen Spiel — hinter, dazwischen oder davor.', category: 'tactics' },
  { id: 'low', term: 'Low', shortDefinition: 'Eher unter / hinter dem aktuellen Spiel.', category: 'tactics', glossarySlug: 'low' },
  { id: 'middle', term: 'Middle', shortDefinition: 'Eher auf Verbindungshöhe zwischen tiefem und hohem Spiel.', category: 'tactics', glossarySlug: 'middle' },
  { id: 'high', term: 'High', shortDefinition: 'Eher vor / oberhalb des aktuellen Spiels.', category: 'tactics', glossarySlug: 'high' },
